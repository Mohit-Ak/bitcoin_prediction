...
parser.add_argument("outputfile", nargs='?', default="tweets_bitcoin_final.json")
parser.add_argument("errorfile", nargs='?', default="tweets_bitcoin_error_final.txt")
...
if __name__ == "__main__":
	...
	myStream.filter(track=['bitcoin','BTC','$BTC'],async=True)
