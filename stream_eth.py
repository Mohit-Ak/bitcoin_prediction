...
parser.add_argument("outputfile", nargs='?', default="tweets_ETH_final.json")
parser.add_argument("errorfile", nargs='?', default="tweets_ETH_error_final.txt")
...
if __name__ == "__main__":
	...
	myStream.filter(track=['ethereum','ETH','ether','$ETH'],async=True)
