...
parser.add_argument("outputfile", nargs='?', default="tweets_litecoin_final.json")
parser.add_argument("errorfile", nargs='?', default="tweets_litecoin_error_final.txt")
...
if __name__ == "__main__":
	...
	myStream.filter(track=['litepay','litecoin','LTC','$LTC'],async=True)
